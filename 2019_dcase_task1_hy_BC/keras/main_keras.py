...
from models_keras import Vggish, Vggish_two_attention
...
def train(args):
    ...
    if mini_data:
        hdf5_path = os.path.join(workspace, 'features', 'logmel', subdir,
                                 'mini_BClearning_development.h5')
    else:
        hdf5_path = os.path.join(workspace, 'features', 'logmel', subdir,
    ...
    model = Vggish_two_attention(seq_len, mel_bins, 10)
...
def inference_validation_data(args):
    ...
    model_path = os.path.join(workspace, 'models', subdir, filename,
                              ...
                              "md_17000_iters_max_attention2_2019-11-22 19:05:42.h5")
    ...
    for device in devices:
        ...
        #hf = h5py.File('keras/hpss_lrad_3m.h5')
        # hf = h5py.File(hdf5_path)
