...
def train(args):
    ...
    if mini_data:
        ...
        hdf5_path = os.path.join(workspace, 'features', 'logmel', subdir,
                                 'development_development_train_(2,320,64).h5')
    ...
    model = resnet_50(2,seq_len,mel_bins,10)
    logging.info("loading resnet_net")
    # else:
...
def inference_validation_data(args):
    ...
    #============================模型地址=======================================
    model_path = "/home/r506/hhy/workspace/models/TUT-urban-acoustic-scenes-2018-development/main_keras/holdout_fold=1/md_7400_iters_max_resnet_50_2019-10-31 17:14:36.h5"
    model = keras.models.load_model(model_path)
